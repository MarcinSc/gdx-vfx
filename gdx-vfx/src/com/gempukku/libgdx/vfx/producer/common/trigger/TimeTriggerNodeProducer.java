...
public class TimeTriggerNodeProducer extends AbstractVfxNodeProducer {
    ...
    private static class TimeTriggerNode extends AbstractVfxNode implements VfxTriggerNode {
        ...
        public boolean isTriggered() {
            TimeProvider timeProvider = configuration.getEffectTimeKeeper();
            return !processed && timeProvider.getTime() >= time;
        }
        ...
        public void processTrigger() {
            ...
            DefaultVfxProcess vfxProcess = Pools.obtain(DefaultVfxProcess.class);
