package com.gempukku.libgdx.vfx.desktop;
...
import com.gempukku.libgdx.vfx.assistant.GdxVfxAssistantPlugin;

public class VFXEditorLauncher {
    ...
    private static class LegacyGraphPluginProvider implements PluginsProvider<AssistantApplication, AssistantPlugin> {
        ...
        public LegacyGraphPluginProvider() {
            ...
            plugins.add(new GdxVfxAssistantPlugin());
        }
